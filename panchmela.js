...
function initSupporterBadge() {
  const getBadgeBtn = document.getElementById('getBadgeBtn');
  if (!getBadgeBtn) return;

  getBadgeBtn.addEventListener('click', () => {
    // Alert or action for the supporter badge
    alert("Thank you for your support!\n\nBy supporting the project I promise I owe the children of the nation at least a sum of 100 rupees.");
    // Optionally redirect to donation
    window.location.href = "mailto:inhetedu@zohomail.in?subject=Supporter Badge - iNHET&body=By supporting the project I promise I owe the children of the nation at least a sum of 100 rupees.";
  });
}
